                ...
                <div className="w-96 text-gray-600 space-y-5 p-4 shadow-xl border rounded-xl">
                    ...
                    <form onSubmit={onSubmit} className="space-y-4">
                        ...
                        <div>
                            ...
                            <input disabled={isRegistering} type="password" autoComplete='new-password' required
                        ...
                        <div>
                            ...
                            <input disabled={isRegistering} type="password" autoComplete='off' required
                        ...
                        <button type="submit" disabled={isRegistering} className={`w-full px-4 py-2 text-white font-medium rounded-lg ${isRegistering ? 'bg-gray-300 cursor-not-allowed' : 'bg-indigo-600 hover:bg-indigo-700 hover:shadow-xl transition duration-300'}`}>
